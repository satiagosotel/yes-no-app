          ...
          leading: Padding(
            ...
            child: CircleAvatar(
              backgroundImage: NetworkImage(
                  'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmedia.licdn.com%2Fdms%2Fimage%2Fv2%2FD4D03AQGuNkc-EhshIg%2Fprofile-displayphoto-shrink_200_200%2Fprofile-displayphoto-shrink_200_200%2F0%2F1725808193047%3Fe%3D2147483647%26v%3Dbeta%26t%3DLrXtq49POypDvNJUhjXv5BlFPH8ITGL0EcZVaBYxZEM&f=1&nofb=1&ipt=7cad9e81024757373f27fbdedd8393f022c549c82f251f909c916d8adb99a6cc'),
            ),
          ),
        ...
        child: Column(
          children: [
            Expanded(
              ...
              itemCount: chatProvider.messageQueue.length,
              itemBuilder: (context, index) {
                final message = chatProvider.messageQueue[index];

                return (message.fromWho == FromWho.he)
